...
\begin{table}%[h]
	...
	\begin{tabularx}{\textwidth}{p{0.3\linewidth} | c | p{0.555\linewidth}}
		...
		R1.1 and R1.2\newline(Un-)\,Subscription to/from Event Source & o & requires additional model elements, \eg~throw/catch event, send/receive task, service task \\
		...
		R2.3 Awareness of Subscription Dependencies & o & if subscription is modeled explicitly, DataInput can be used \\
