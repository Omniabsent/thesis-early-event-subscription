...
\todo[inline]{a receive task must be used at the beginning to allow data output}
...
\todo[inline]{this means that there are a lot more instances than necessary, performance and management overhead. further discussed in ...}
