...
\todo[inline]{look up the control flow of receiveTask. It might have different execution semantics as it doesn't reference the MessageReceiveEvent, but the Message directly.}
...
\todo[inline]{add table overview of all extension fields with some details. Look that it doesnt double with the table-todo in automatic-subscription}
...
\todo[inline]{illustrate using Example 1.1}
