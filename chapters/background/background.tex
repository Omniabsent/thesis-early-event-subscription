...
\missingfigure{Sample BPMN model with 2 participants, maybe the same as before, but with 2 lanes and communication in-between. known participant hidden. use special task type and data}
...
\todo[inline]{More precisely, Events are defined as follows... see heikos thesis? \cite{luckham2008power}}
...
\missingfigure{state-transition-diagram of temporal order}
...
\todo[inline]{in short: more on epl, what can it do? windows, joins, filters,patterns}
